ARMIPS assembler v0.7b, released 19th September 2009
by Kingcom
...
The first and third argument are encoding according to the
...
Defines Label with the given value.
...
However, there is still a limitation at the moment. The macros
cannot contain labels, or else the assembler will complain
about multiple definitions. This behavior will be fixed in
the next revision.
...
#################################
  ...
  -macros can't define labels yet
